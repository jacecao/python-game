...
# 构建词库为字典类型	  
words = {
	'Colors': 'red orange yellow green blue pink black brown'.split(),
	'Fruits': 'apple lemon pear cherry banana mango tomato'.split(),
	'Animals': 'cat dog monkey duck fish mouse panda python'.split()
}
...
def main ():
	...
	missLetters = ''
	correctLetters = ''
	secretWord, secretWordType = getRandomWord(words)
	...
	while True:
		# 向玩家提示词语的分类
		print('the secret word is in the set: ' + secretWordType)
